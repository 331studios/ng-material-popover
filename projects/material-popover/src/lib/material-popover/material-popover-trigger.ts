...
import { MdePopoverPanel, MdeTarget } from './material-popover-interfaces';
...
import { throwMdePopoverMissingError } from './material-popover-errors';
...
export class MdePopoverTrigger implements AfterViewInit, OnDestroy {
    ...
    @Input('mdePopoverPositionX') positionX: MdePopoverPositionX = 'after';

    /** Position of the popover in the Y axis */
    @Input('mdePopoverPositionY') positionY: MdePopoverPositionY = 'above';

    /** Popover trigger event */
    @Input('mdePopoverTriggerOn') triggerEvent: MdePopoverTriggerEvent = 'none';
    ...
    //default for boolean should be false when there is no default state
    @Input('mdePopoverOverlapTrigger') overlapTrigger: boolean = false;
    ...
    private _setCurrentConfig() {
        ...
        if (this.overlapTrigger || !this.overlapTrigger) {
    ...
    */
    private _subscribeToBackdrop(): void {
      if (this._overlayRef) {
        ...
        if (this.triggerEvent === 'click' && this.backdropCloseOnClick) {
