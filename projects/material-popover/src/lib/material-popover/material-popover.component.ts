...
import { MdePopoverPositionX, MdePopoverPositionY, MdePopoverTriggerEvent, MdePopoverScrollStrategy } from './material-popover-types';
import { throwMdePopoverInvalidPositionX, throwMdePopoverInvalidPositionY } from './material-popover-errors';
import { MdePopoverPanel } from './material-popover-interfaces';
import { transformPopover } from './material-popover-animations';

@Component({
  selector: 'mde-popover',
  templateUrl: './material-popover.html',
  styleUrls: ['./material-popover.scss'],
...
export class MaterialPopoverComponent implements MdePopoverPanel, OnDestroy { // tslint:disable-line:component-class-suffix
  ...
  public popoverPanelStyles: {} | undefined;

  /** Config object to be passed into the popover's arrow ngStyle */
  public popoverArrowStyles: {} | undefined;

  /** Config object to be passed into the popover's content ngStyle */
  public popoverContentStyles: {} | undefined;
  ...
  setCurrentStyles() {
    ...
    this.popoverContentStyles = {
      'padding-top': this.overlapTrigger ? '0px' : this.arrowWidth + 'px',
      'padding-bottom': this.overlapTrigger ? '0px' : (this.arrowWidth) + 'px',
      'margin-top': !this.overlapTrigger && this.positionY === 'below' && !this.containerPositioning ?
